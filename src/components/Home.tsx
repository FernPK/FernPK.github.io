...
const Home = () => {
  return (
    <section id='home'>
      <div className='flex flex-col justify-center items-center h-screen bg-white xl:mx-28 lg:mx-16 md:mx-8 sm:gap-20 gap-10'>
        <div className='flex md:flex-row flex-col justify-center items-center xl:gap-16 lg:gap-8 gap-6'>
          <div className='bg-image-border-on-white rounded-full p-3'>
            <Image src='/images/Profile.jpg' alt="Pornnapat's Profile" width={240} height={240} className='rounded-full xl:w-60 lg:w-56 md:w-48 sm:w-40 w-32'></Image>
          </div>
          <div className='flex flex-col md:w-7/12 w-5/6 md:text-left text-center'>
            ...
            <div className='flex sm:flex-row flex-col gap-4 md:mt-0 mt-1 md:justify-start justify-center'>
              <a className='border border-white bg-primary text-white hover:bg-primary-hover button xl:text-xl lg:text-lg text-base lg:py-2 lg:px-4' href='https://drive.google.com/file/d/1I4N4xGlUO3ojwpmOyAiGJHdppu-EUstB/view?usp=share_link' target='_blank'>
